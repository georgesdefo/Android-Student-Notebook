...
public class Utils {
	...
	private static String getFilePath(String Direc, String extension,String nameFile){ 
	   ...
	   // Toast.makeText(mic.getApplicationContext(), file.getAbsolutePath(),Toast.LENGTH_SHORT).show();
	   ...
	   Log.v("WAY", cheminfinal);
	   //Toast.makeText(mic.getApplicationContext(), cheminfinal,Toast.LENGTH_SHORT).show();
		return cheminfinal;
	}
}
